...
either has been or will be submitted during the 3DV 2021 review period to
...
Mermin's description of how to write mathematics.%: \url{http://www.pamitc.org/documents/mermin.pdf}.
...
anonymized parallel submission~\cite{Authors12final} as additional material and
cite it as
\begin{quote}
[1] Authors. ``The frobnicatable foo filter'', F\&G 2021 Submission ID 324,
...
in~\cite{Authors12bfinal}''.  Then submit the techreport as additional material.
...
number rather than the 4321 in the example.  To do this find the line (around
line 23)
\begin{verbatim}
%\ifthreedvfinal\pagestyle{empty}\fi
\setcounter{page}{4321}
...
example~\cite{Authors12final}.  Where appropriate, include the name(s) of
